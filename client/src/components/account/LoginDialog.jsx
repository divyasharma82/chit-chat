...
const LoginDialog = () => {
    ...
    return (
        ...
        >
            <Component>
                <Container>
                    <Title>To Use Chit-Chat on your Computer:</Title>
                    <StyledList>
                        <ListItem>1. Open ChitChat on your phone</ListItem>
                        <ListItem>2. Tap Menu Settings and select Chit-chat App</ListItem>
                        <ListItem>3.Login From your gmail account</ListItem>
                    </StyledList>
                </Container>
